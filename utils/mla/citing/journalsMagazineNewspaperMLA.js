...
const citeJournMagNewsArticle = ( { authors, title, container, contributor, volume, issue, date, page, database, urlOrDoi}) => {
    ...
    return formattedAuthors + formattedTitle + formattedContainer + formattedContributor + formattedVolume 
